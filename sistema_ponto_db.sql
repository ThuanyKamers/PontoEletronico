...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/06/2025 às 23:43
...
(97, 6, 'DOACAO_SANGUE', '2025-06-28', '2025-06-28', 'Doação de sangue', NULL),
(98, 6, 'DOACAO_SANGUE', '2025-06-30', '2025-06-30', 'Doação de sangue', NULL),
(99, 6, 'ACOMPANHAMENTO_CONJUGE', '2025-06-26', '2025-06-26', 'Teste', NULL),
(100, 6, 'ATESTADO', '2025-06-27', '2025-06-27', 'teste2', NULL),
(101, 6, 'DOACAO_SANGUE', '2025-06-27', '2025-06-27', 'teste3', NULL),
(102, 6, 'DOACAO_SANGUE', '2025-05-30', '2025-05-30', 'teste4', NULL),
(103, 1, 'ATESTADO', '2025-06-26', '2025-07-07', 'solicito atestado', 'uploads/comprovantes/anexo_685d9b59c7c4c8.02726732.jpg');
...
(13, 6, '2025-06-05', NULL, NULL, 'PONTO_INCORRETO', 'troca aí fzd o favor', NULL, '2025-06-05 20:04:05', 'APROVADA', 'pronto', NULL, '00:00:00', '', NULL),
(14, 6, '2025-06-05', NULL, NULL, 'PONTO_INCORRETO', 'troca aí pra mim', NULL, '2025-06-05 20:20:07', 'REJEITADA', '', NULL, '00:00:00', '', NULL),
...
(19, 6, '2025-06-06', NULL, NULL, 'PONTO_INCORRETO', 'arruma pfv', NULL, '2025-06-06 17:35:27', 'APROVADA', 'funciona em nome de JESUS', NULL, '14:36:00', 'FIM_JORNADA', NULL),
...
(6, 'Lucas Freitas Sagás', 'lucas@gmail.com', '489555555555', '2025-06-01', 'Engenheiro eletricista', '2000-01-28', '$2y$10$3RN/siHm0V9tdPdsU6JYT.zm1mCLFeZ1qotemw5jnJBkFE5Wg5H5e', 'empregado', 'ativo', 5, '2025-06-05 19:41:14', '12345678909', 'rua dos apóstolos', '64', NULL, 'caminho novo', 'palhoça', 'SC', '88130000', 4500.00, 'mensal'),
...
--
ALTER TABLE `ocorrencias`
  MODIFY `id_ocorrencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT de tabela `registros_ponto`
--
ALTER TABLE `registros_ponto`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=553;

--
-- AUTO_INCREMENT de tabela `solicitacoes_alteracao`
--
ALTER TABLE `solicitacoes_alteracao`
  MODIFY `id_solicitacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
