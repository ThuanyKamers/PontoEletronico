...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/06/2025 às 23:23
...
(91, 1, 'ATESTADO', '2025-06-09', '2025-06-09', 'Atestado.', 'uploads/6853278a05f3b-'),
(92, 1, 'ATESTADO', '2025-06-09', '2025-06-10', 'Atestado.', 'uploads/685327c4ac97b-'),
...
--
ALTER TABLE `ocorrencias`
  MODIFY `id_ocorrencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT de tabela `registros_ponto`
--
ALTER TABLE `registros_ponto`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=523;
