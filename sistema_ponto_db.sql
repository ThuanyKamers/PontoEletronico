...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/06/2025 às 20:43
...
(68, '2025-06-25', 'Teste', 'Nacional', NULL, NULL);
...
(23, 1, '2025-06-10', 'PONTO_INCORRETO', 'ajuste aí', NULL, '2025-06-10 14:41:38', 'REJEITADA', 'Negado.', NULL, '11:50:00', 'FIM_JORNADA', NULL),
...
--
ALTER TABLE `feriados`
  MODIFY `id_feriado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `ocorrencias`
  MODIFY `id_ocorrencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
